package com.labkomuin.hello.tabhost;
...
public class MainActivity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabMenu1.setContent(new Intent(this,Tab_1.class));

        //Setting up tab 2 name.
        TabMenu2.setIndicator("Tab2");
        //Set tab 3 activity to tab 1 menu.
        TabMenu2.setContent(new Intent(this,Tab_2.class));

        //Setting up tab 2 name.
        TabMenu3.setIndicator("Tab3");
        //Set tab 3 activity to tab 3 menu.
        TabMenu3.setContent(new Intent(this,Tab_3.class));
